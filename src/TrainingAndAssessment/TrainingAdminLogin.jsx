  ...
  const TrainingLogo = () => (
    <button type="button" onClick={goToTrainingHome} className="ltc-logo" aria-label="Go to training home">
      ...
      <div>
        ...
        <p style={fontPontano}>Courses, enrollment, batches, and competencies.</p>
      </div>
    </button>
  );
        ...
        <main className="ltc-container ltc-login-main">
          <section className="ltc-login-copy">
            ...
            <h2 style={fontMontserrat}>
              Training <span>&amp; Assessment</span>
            </h2>

            <p style={fontPontano}>
              Sign in to manage enrollments, courses, batches, professors, RFID records, and competencies.
            </p>
            ...
            <div className="ltc-location-box">
              ...
              <div>
                ...
                <p style={fontPoppins}>Curie Street training operations</p>
              </div>
            </div>
          </section>
          ...
          <section className="ltc-login-card">
            <div className="ltc-card-title">
              <p style={fontMontserrat}>Training Admin Account</p>
            ...
            <form className="ltc-login-form" onSubmit={submit}>
