...
function BillingStatCard({ title, value, note, tone = "green" }) {
  ...
  return (
    <div className="group relative flex min-h-[132px] min-w-0 flex-col justify-between overflow-hidden rounded-3xl border border-white/80 bg-white p-6 shadow-[0_18px_45px_rgba(8,39,25,0.10)] ring-1 ring-black/5 transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_70px_rgba(8,39,25,0.16)]">
      ...
      <div className="relative min-w-0">
        ...
        <p className={`mt-4 break-words text-[clamp(1.65rem,2.4vw,2.35rem)] font-black leading-none tracking-tight ${valueColor}`}>
          {value}
        </p>
        {note ? (
          <p className="mt-3 text-sm font-semibold text-[#071f14]/55">
            {note}
          </p>
        ) : null}
      </div>
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#edf3ee] font-sans text-[#071f14]">
      ...
      <div className="min-h-screen">
        ...
        <main className="min-w-0 px-5 py-6 lg:ml-[270px] lg:px-8">
          ...
          <section className="mt-7 grid items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5">
