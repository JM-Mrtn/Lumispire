...
const embeddedChatStyles = `
  ...
  .ltc-chat-embedded .ltc-chat-card {
    height: 100%;
    border-radius: 20px;
    box-shadow: none;
  }

  .ltc-chat-embedded .ltc-chat-card-header {
    padding: 18px 20px;
  }

  .ltc-chat-embedded .ltc-chat-card-header h2 {
    font-size: 22px;
  }

  .ltc-chat-embedded .ltc-chat-card-header p {
    font-size: 12px;
    line-height: 1.55;
  }

  .ltc-chat-embedded .ltc-chat-inline-status {
    margin: 14px 16px 0;
  }

  .ltc-chat-embedded .ltc-chat-form-wrap {
    padding: 16px;
  }

  .ltc-chat-embedded .ltc-chat-window {
    height: 390px;
    padding: 16px;
  }

  .ltc-chat-embedded .ltc-compose-bar {
    padding: 14px;
  }

  .ltc-chat-embedded .ltc-message-bubble {
    max-width: 90%;
  }

  .ltc-chat-embedded .ltc-primary-button {
    min-width: 112px;
  }
...
export default function HotelChatEmbedded() {
  ...
  return (
    <div className="ltc-chat-page ltc-chat-embedded" style={fontPontano}>
      <style>{`${pageStyles}\n${embeddedChatStyles}`}</style>
      ...
      <div className="ltc-chat-card">
        <div className="ltc-chat-card-header">
          <div>
            ...
            <p style={fontPoppins}>
              Send a concern first, then continue chatting with hotel support without leaving your profile.
            </p>
          </div>
        </div>
