...
export default function ManpowerAdminLogin() {
  ...
  const ManpowerLogo = () => (
    <button type="button" onClick={goToManpowerHome} className="ltc-logo" aria-label="Go to manpower home">
      ...
      <div>
        <h1 style={fontMontserrat}>Manpower Admin</h1>
        ...
        <main className="ltc-container ltc-login-main">
          <section className="ltc-login-copy">
            ...
            <h2 style={fontMontserrat}>
              Manpower <span>Management</span>
            </h2>

            <p style={fontPontano}>
              Sign in to manage employee accounts, job records, manpower assignments, and payroll deduction settings.
            </p>
            ...
            <div className="ltc-location-box">
              ...
              <div>
                ...
                <p style={fontPoppins}>Centralized manpower administration portal</p>
              </div>
            </div>
            ...
            <div className="ltc-location-box">
              ...
              <div>
                <h3 style={fontMontserrat}>Secure Admin Access</h3>
                <p style={fontPoppins}>Employee records, jobs, and payroll deduction controls</p>
              </div>
            </div>
          </section>
          ...
          <section className="ltc-login-card">
            <div className="ltc-card-title">
              <p style={fontMontserrat}>LTC Group of Companies</p>
