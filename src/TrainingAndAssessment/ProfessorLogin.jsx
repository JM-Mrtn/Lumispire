...
export default function ProfessorLogin() {
  ...
  const goToTrainingHome = () => navigate("/training");
  ...
  const ProfessorLogo = () => (
    <button type="button" onClick={goToTrainingHome} className="ltc-logo" aria-label="Go to training home">
      ...
      <div>
        <h1 style={fontMontserrat}>Professor Portal</h1>
        <p style={fontPontano}>Attendance, assessments, scores, and trainee records.</p>
      </div>
    </button>
  );
        ...
        <header className="ltc-header">
          <div className="ltc-container ltc-nav">
            ...
            <nav className="ltc-desktop-nav" style={fontPoppins}>
              ...
              <button type="button" onClick={goToTrainingHome} className="ltc-nav-link active">
                TRAINING
              </button>
            </nav>
          </div>
        ...
        <main className="ltc-container ltc-login-main">
          <section className="ltc-login-copy">
            ...
            <h2 style={fontMontserrat}>
              Training <span>Professor</span>
            </h2>

            <p style={fontPontano}>
              Sign in to manage attendance, assessments, scores, trainee feedback, and class records.
            </p>
            ...
            <div className="ltc-location-box">
              ...
              <div>
                <h3 style={fontMontserrat}>Professor Dashboard</h3>
                <p style={fontPoppins}>Class records and trainee progress tools</p>
              </div>
            </div>
            ...
            <div className="ltc-location-box">
              ...
              <div>
                <h3 style={fontMontserrat}>LTC Training Center</h3>
                <p style={fontPoppins}>Professional training and assessment services</p>
              </div>
            </div>
          </section>
          ...
          <section className="ltc-login-card">
            <div className="ltc-card-title">
              <p style={fontMontserrat}>Professor Account</p>
              <h1 style={fontMontserrat}>
                Professor <span>Login</span>
              </h1>
            </div>
            ...
            <form className="ltc-login-form" onSubmit={onSubmit}>
