      ...
      <div className="min-h-screen bg-[#2f523d] font-['Inter',sans-serif]">
        ...
        <main className="flex min-h-[calc(100vh-180px)] items-center justify-center bg-[#2f523d] px-4 py-10">
          <div className="w-full max-w-md rounded-md bg-white/15 px-6 py-8 text-center shadow-[0_18px_45px_rgba(0,0,0,0.12)] backdrop-blur-[1px]">
            <h1 className="font-['Montserrat',sans-serif] text-[28px] font-extrabold text-white">
            ...
            <button
              ...
              type="button"
              className="mt-6 h-9 rounded-full bg-white px-10 font-['Montserrat',sans-serif] text-[11px] font-extrabold uppercase text-[#3f5b44] shadow-sm transition hover:bg-[#fffde9]"
            >
              Back to Form
            </button>
          </div>
      ...
      <main className="bg-[#2f523d] px-4 pb-7 pt-5 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1180px]">
          <div className="mb-5 text-center">
            ...
            <div className="mx-auto mt-2 h-[2px] w-[300px] bg-white/80" />
          </div>

          <div className="rounded-md bg-white/15 px-5 py-8 shadow-[0_18px_45px_rgba(0,0,0,0.12)] backdrop-blur-[1px] sm:px-7 lg:px-8">
            {status.message ? (
              <div
                className={`mb-5 rounded-xl border px-4 py-3 text-sm font-semibold ${statusStyles}`}
              >
                {status.message}
              </div>
            ) : null}
              ...
              <div className="mt-9 rounded-md bg-[#f7f7f2] px-4 py-4 text-[#314f3b]">
                <div className="flex items-start justify-between gap-5">
                  <div>
                    ...
                    <div className="mt-3 space-y-2 text-sm font-semibold sm:text-base">
                      <p>{isDownPayment ? "Down payment" : "Full Payment"}</p>
                      <p>Total Balance</p>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-3 space-y-2 text-sm font-semibold sm:text-base">
                      <p>{formatPeso(amountToPay)}</p>
                      <p>{formatPeso(balanceAmount)}</p>
                    </div>
                  </div>
                </div>
              </div>
