...
const pageStyles = `
  ...
  .ltc-primary-button:hover:not(:disabled) {
    ...
    box-shadow: 0 24px 45px rgba(215,168,77,.32);
  }
  ...
  .ltc-secondary-button:hover:not(:disabled) {
    transform: translateY(-2px);
    box-shadow: 0 22px 42px rgba(8,39,25,.24);
  }
        ...
        <section className="ltc-hero">
          ...
          <div className="ltc-container ltc-hero-content">
            ...
            <p className="ltc-hero-text" style={fontPontano}>
              Update your hotel account password safely using OTP verification sent to your email.
            </p>
          </div>
        </section>
...
function Header({ navigate }) {
  const isSignedIn = localStorage.getItem("token") || localStorage.getItem("hotelToken");
      ...
      <div className="ltc-container ltc-nav">
        ...
        <nav className="ltc-desktop-nav" style={fontPoppins}>
          ...
          <NavButton
            ...
            onClick={() => navigate(isSignedIn ? "/hotel-profile" : "/hotel-login")}
