...
const HotelAdminReviews = () => {
  ...
  return (
    <div className="hotel-admin-reviews-shell h-screen w-full overflow-hidden bg-[#f8fbf9] lg:flex">
      ...
      <main className="h-screen min-w-0 w-full overflow-hidden lg:pl-64">
        <div className="hotel-admin-reviews-scroll h-full w-full overflow-y-auto overflow-x-hidden overscroll-contain">
      ...
      <style>{`
        ...
        .hotel-admin-reviews-shell,
        .hotel-admin-reviews-shell * {
          box-sizing: border-box;
        }

        .hotel-admin-reviews-scroll {
