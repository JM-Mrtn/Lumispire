...
router.get("/professor/status", requireProfessor, getProfessorRfidAttendanceStatus);
router.post("/professor/open", requireProfessor, openProfessorRfidAttendance);
router.patch("/professor/close", requireProfessor, closeProfessorRfidAttendance);
