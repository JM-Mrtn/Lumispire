...
const EMPLOYEE_NAV_ITEMS = [
  { key: "home", label: "Home", path: EMPLOYEE_HOME_ROUTE },
  { key: "payroll", label: "Payroll", path: EMPLOYEE_PAYROLL_ROUTE },
...
function PayrollIcon() {
  return (
    <svg viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="18" y="22" width="54" height="44" rx="7" stroke="currentColor" strokeWidth="3" />
      <path d="M18 34H72" stroke="currentColor" strokeWidth="3" />
      <path d="M31 48H43M31 57H54" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
      <circle cx="62" cy="53" r="6" stroke="currentColor" strokeWidth="3" />
      <path d="M60.5 50.5H63.5M62 47.5V58.5" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
...
function LeaveIcon() {
  return (
    <svg viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="20" y="20" width="50" height="52" rx="7" stroke="currentColor" strokeWidth="3" />
      <path d="M31 15V27M59 15V27M20 34H70" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
      <path d="M34 49L42 57L57 42" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
      ...
      <div className="ltc-container">
        <div className="ltc-nav">
          <button
            ...
            className="ltc-logo"
            aria-label="Manpower Employee Home"
          >
            <img
              src={LOGO_IMAGE}
              alt="Manpower Logo"
              ...
              onError={(event) => {
                event.currentTarget.src = "https://placehold.co/80x80/ffffff/45674b?text=M";
              }}
            />
            <div>
  ...
  return (
    <button type="button" onClick={onClick} className="ltc-quick-card">
      <span className="ltc-icon-frame">
        {icon === "payroll" ? <PayrollIcon /> : <LeaveIcon />}
      </span>
      ...
      <div className="ltc-container ltc-footer-grid">
        <div>
          ...
          >
            ...
            />
            <h4 style={fontMontserrat}>MANPOWER</h4>
          </button>
        </div>
        ...
        <FooterColumn title="Menu">
          ...
          <FooterLink onClick={() => goTo(EMPLOYEE_PROFILE_ROUTE)}>Profile</FooterLink>
        </FooterColumn>

        <FooterColumn title="Contact Information">
          <FooterText>{MANPOWER_CONTACT_INFO.email1}</FooterText>
          <FooterText>{MANPOWER_CONTACT_INFO.email2}</FooterText>
          <FooterText>{MANPOWER_CONTACT_INFO.phone}</FooterText>
        </FooterColumn>

        <FooterColumn title="Address">
          <FooterText>{MANPOWER_CONTACT_INFO.addressLine1}</FooterText>
          <FooterText>{MANPOWER_CONTACT_INFO.addressLine2}</FooterText>
        </FooterColumn>
        ...
        <section className="ltc-hero">
          ...
          <div className="ltc-container ltc-hero-content">
            ...
            <p className="ltc-hero-text" style={fontPontano}>
              Select Payroll or File Leave to continue.
            </p>
          </div>
        </section>
        ...
        <section className="ltc-section">
          <div className="ltc-container">
            <div className="ltc-home-shell">
              <div className="ltc-quick-grid" aria-label="Employee portal actions">
                <ActionCard
                  title="Payroll"
                  subtitle="View your salary slips and payroll history."
                ...
                <ActionCard
                  title="File Leave"
                  subtitle="Submit and monitor your leave requests."
