        ...
        <section className="ltc-section">
          <div className="ltc-container">
            <RevealOnScroll className="ltc-section-title">
              ...
              <h3 style={fontMontserrat}>Reset your hotel account password</h3>
              <p style={fontPontano}>
                Use the email connected to your Patio de Lorenzo hotel account.
              </p>
            </RevealOnScroll>
            ...
            <div className="ltc-forgot-wrapper">
              <RevealOnScroll className="ltc-forgot-card">
                ...
                <p className="ltc-forgot-subtitle" style={fontPontano}>
                  No worries. Enter your email below and follow the reset instructions sent to your inbox.
                </p>
                ...
                <form
                  ...
                  className="ltc-forgot-form"
                >
                  <div className="ltc-field">
                    <label style={fontMontserrat}>Enter Email</label>
